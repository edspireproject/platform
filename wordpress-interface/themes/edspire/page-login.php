 ...
 * 
 * XXX: This has been customized to use the LinkedIn API for login
 *
 * @package WordPress
 */
...
// check if we have to do some LinkedIn stuff
...
function login_header( $title = 'Log In', $message = '', $wp_error = '' ) {
	...
	echo '<div class="headfaker"> </div> <div class="w0">';

	echo '<h1>' . $title . '</h1><div id="lp0">';
...
<?php
          ...
          if($_SESSION['oauth']['linkedin']['authorized'] === TRUE) {
            ...
            ?>
            <h2>Your LinkedIn account is already connected</h2>
            ...
            ?>
            <h2>Or use your LinkedIn account</h2>
            <form id="linkedin_connect_form" action="<?php echo esc_url( wp_login_url() );?>" method="get">
              ...
              <input type="submit" value="Connect with LinkedIn" />
            </form>
            <?php
          }
          ?>	 
...
function retrieve_password() {
	...
	$message .= '<' . network_site_url("login/?action=rp&key=$key&login=" . rawurlencode($user_login), 'login') . ">\r\n";
...
<form name="lostpasswordform" id="lostpasswordform" action="<?php echo esc_url( site_url( 'login/?action=lostpassword', 'login_post' ) ); ?>" method="post">
	<p>
...
?>
<form name="resetpassform" id="resetpassform" action="<?php echo esc_url( site_url( 'login/?action=resetpass&key=' . urlencode( $_GET['key'] ) . '&login=' . urlencode( $_GET['login'] ), 'login_post' ) ); ?>" method="post" autocomplete="off">
...
<form name="registerform" id="registerform" action="<?php echo esc_url( site_url('login/?action=register', 'login_post') ); ?>" method="post">
	<p>
