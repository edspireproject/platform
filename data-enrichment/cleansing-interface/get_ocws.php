...
"inner join le_postmeta f on p.id = f.post_id and f.meta_key = 'wpcf-format' and f.meta_value = 'ocw' " .
...
$ix = 0;
foreach($f_ocws as $f_ocw) {
	$sql .= "left outer join le_postmeta m" . $ix . " on p.id = m" . $ix . ".post_id and m" . $ix . ".meta_key = 'wpcf-" . str_replace('_', '-', $f_ocw) . "' ";
	$ix++;
}
